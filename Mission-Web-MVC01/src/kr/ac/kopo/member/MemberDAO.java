...
public List<MemberVO> selectAll(){
		...
		try(
			...
			while(rs.next()) {				
				...
				MemberVO memberDetail = new MemberVO(name, id, emailDomain,emailId,tel1,tel2,tel3,basicAddr, detailAddr, post, regDate , type , password); 
	...
	public MemberVO selectOne(String name) {
		StringBuilder sql = new StringBuilder();
		sql.append("select");
		sql.append(" ID,NAME,PASSWORD,EMAIL_ID,EMAIL_DOMAIN,TEL1,TEL2,TEL3,POST,BASIC_ADDR,DETAIL_ADDR,TYPE,REG_DATE");
		sql.append(" from t_member");
